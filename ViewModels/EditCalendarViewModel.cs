...
{
    public class EditCalendarViewModel : BaseViewModel, IQueryAttributable
    {
        public const string ViewName = "EditCalendarPage";
        int apptId;
        DateTime startTime;
        DateTime endTime;
        DateTime startDate;
        ...
        {
            query.TryGetValue("appointmentId", out object _appointmentId);
            query.TryGetValue("startTime", out object _startTime);
            query.TryGetValue("endTime", out object _endTime);
            query.TryGetValue("subject", out object _subject);
            query.TryGetValue("labelId", out object _labelId);
            query.TryGetValue("location", out object _location);
            apptId = (int)_appointmentId;
            startTime = (DateTime)_startTime;
            endTime= (DateTime)_endTime;
            startDate = (DateTime)_startTime;
            endDate = (DateTime)_endTime;
            subject = (string)_subject;
            labelId = ((int)_labelId).ToString();
